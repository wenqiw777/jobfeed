...
**New variables in this phase:** 3 — (1) JobSpy/pandas/tls-client outbound scraping, (2) Playwright browser automation with a persistent auth profile, (3) the two-phase SessionSource orchestration in ScanService. This is deliberately the largest phase; the risk-ordered task sequence (below) isolates each new variable.
